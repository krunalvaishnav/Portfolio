      ...
      <div className="w-full max-w-6xl flex flex-col lg:flex-row justify-between items-start lg:space-x-16 text-left  pb-4 lg:mb-35">
        <div className="w-full lg:w-1/2 mb-8 lg:mb-0">
          <div className="flex flex-col items-center lg:items-start">
            <h1 className="pb-4 font-semibold tracking-tight lg:mt-16 text-7xl">
              Krunal Vaishnav
            </h1>
            <span className="bg-gradient-to-r from-pink-300 via-slate-400 to-purple-500 bg-clip-text text-4xl text-transparent">
              Full Stack Developer
            </span>
            <p className="my-3 py-2 max-w-xl font-light tracking-tighter text-center lg:text-left">
            ...
            <a
              ...
              className="mt-4 inline-block bg-gradient-to-r from-blue-900 via-blue-500 to-blue-900 text-white font-semibold py-2 px-4 rounded"
            >
              Download CV
            </a>
            {/* <a href="">Contect</a> */}
