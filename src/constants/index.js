...
export const ABOUT_TEXT = `I am a dedicated and versatile full stack developer with a passion for creating efficient and user-friendly web applications. With 5 years of professional experience, I have worked with a variety of technologies, including Reactjs, Nodejs, MySQL, and MongoDB. My journey in web development began with a deep curiosity for how things work, and it has evolved into a career where I continuously strive to learn and adapt to new challenges. I thrive in collaborative environments and enjoy solving complex problems to deliver high-quality solutions. Outside of coding, I enjoy staying active, exploring new technologies, and contributing to open-source projects.`;
...
export const EXPERIENCES = [
  {
    ...
    description: `Gained hands-on experience with JavaScript fundamentals and ES6 concepts. Worked on integrating APIs and developed a dynamic, API-driven React.js application.`,
    technologies: ["Reactjs", "MongoDB", "JavaScript"],
  },
  {
    year: "Jan - 2025",
    role: "Full Stack Developer Intern",
    company: "Hexagon Infosoft Solutions Pvt Ltd",
    description: `Collaborated with the team to design, develop, and maintain full-stack web applications. 
Utilized a wide range of technologies including React.js for frontend, Node.js and Express.js for backend, 
and MySQL and MongoDB for databases. Gained practical experience with authentication (JWT, OAuth), file handling (Multer), 
templating (EJS), real-time communication (Socket.io), and API development and testing using Postman. 
Also worked with Git for version control and Tailwind CSS for styling.`,
    technologies: [
      "HTML",
      "CSS",
      "JavaScript",
...
export const PROJECTS = [
  {
  title: "Xuber - A Service Marketplace Inspired by UrbanClap",
  image: project9,
  description:
    "Xuber is a full-stack service marketplace platform inspired by Urban Company, designed with dedicated panels for Admin, Users, and Service Providers. It features secure login and role-based authentication, service discovery and booking, real-time status updates, document uploads for verification, and an intuitive admin dashboard to manage users, services, and transactions efficiently.",
  technologies: ["React", "Node", "Express", "MySQL", "CSS", "HTML"],
  link: "https://github.com/krunalvaishnav/XUBER.git",
}
,
  {
...
export const CONTACT = {
  address: "Ahmedabad, Gujarat 360410 , India",
